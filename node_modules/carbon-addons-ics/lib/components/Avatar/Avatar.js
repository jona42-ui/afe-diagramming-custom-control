  ...
  _createClass(Avatar, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          defaultIconName = _this$props.defaultIconName,
          size = _this$props.size,
          imgUrl = _this$props.imgUrl,
          rest = _objectWithoutProperties(_this$props, ["className", "description", "defaultIconName", "size", "imgUrl"]);

      var avatarClasses = (0, _classnames.default)(_defineProperty({
        'bx--avatar': true
      }, className, className));
      var avatarSize = avatarSizes[size].avatar;
      var iconSize = avatarSizes[size].icon.toString();
      var imageElement = this.state.imgUrl ? _react.default.createElement("img", {
        ref: function ref(_ref) {
          return _this2.imageDOM = _ref;
        },
        onError: function onError() {
          return _this2.onImgErr();
        },
        onLoad: function onLoad() {
          return _this2.onImgLoad();
        },
      ...
      var iconElement = _react.default.createElement("div", {
        className: 'bx--avatar_icon'
