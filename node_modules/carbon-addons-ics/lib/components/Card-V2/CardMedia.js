  ...
  _createClass(CardMedia, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          rest = _objectWithoutProperties(_this$props, ["className", "children", "type", "src", "altText"]);

      var cardMediaClasses = (0, _classnames.default)(_defineProperty({
        'bx--card__media': true
      }, className, className));
      return _react.default.createElement("div", _extends({}, rest, {
        className: cardMediaClasses
      }), type === 'img' && _react.default.createElement("img", {
        src: src,
        alt: altText,
        className: "bx--card__media-img"
      }), children);
    }
  }]);
...
_defineProperty(CardMedia, "propTypes", {
...
_defineProperty(CardMedia, "defaultProps", {
  type: 'img',
  src: '',
