  ...
  _createClass(Loading, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          rest = _objectWithoutProperties(_this$props, ["active", "className", "withOverlay", "size"]);

      var small = size === 'small' ? true : false;
      var large = size === 'large' ? true : false;
      var loadingClasses = (0, _classnames.default)(className, {
        'bx--loading': small,
      ...
      }), small ? _Loading.SpinnerSml : _Loading.SpinnerLg);
