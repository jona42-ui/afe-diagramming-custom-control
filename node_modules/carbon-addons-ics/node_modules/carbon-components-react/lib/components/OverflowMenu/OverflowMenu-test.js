...
describe('OverflowMenu', function () {
  describe('Renders as expected', function () {
    ...
    var menu = rootWrapper.find('div[role="menu"]');
    var icon = menu.find(!_FeatureFlags.componentsX ? _Icon.default : _.default);
    ...
    it('should set ariaLabel if one is passed via props', function () {
      ...
      expect(rootWrapper.find('div[role="menu"]').props()['aria-label']).toEqual('test label');
    });
    it('should set id if one is passed via props', function () {
      rootWrapper.setProps({
        id: 'uniqueId'
      });
      expect(rootWrapper.find('div[role="menu"]').props().id).toEqual('uniqueId');
    });
    it('should apply a tabindex to the menu', function () {
      if (!_FeatureFlags.breakingChangesX) {
        ...
        var _defaultMenu = (0, _enzyme.mount)(_react.default.createElement(_OverflowMenu.default, null, _react.default.createElement("div", null, "Child"))).childAt(0); // Enzyme doesn't seem to allow props() in a forwardRef-wrapped class component


        expect(_defaultMenu.find('OverflowMenu').instance().props.tabIndex).toBe(0);
      }
    });
  });
  ...
  describe('customized icon', function () {
    it('renders', function () {
      ...
      var nodesWithIconClasses = rootWrapper.find('.bx--overflow-menu__icon');
