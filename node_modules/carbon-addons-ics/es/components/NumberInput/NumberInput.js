...
function (_Component) {
  ...
  function NumberInput(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleChange", function (evt) {
      if (!_this.props.disabled) {
        ...
        _this.setState({
          ...
          labelMotion: evt.target.value === 0 ? Boolean(evt.target.value + 1) : Boolean(evt.target.value)
        }, function () {
    ...
    _this.state = {
      value: _value,
      labelMotion: !!props.defaultValue || !!props.value || props.defaultValue != null || props.value != null
    };
    return _this;
  }
  ...
  _createClass(NumberInput, [{
    ...
    value: function render() {
      ...
      var _this$props2 = this.props,
          ...
          rest = _objectWithoutProperties(_this$props2, ["className", "disabled", "iconDescription", "id", "label", "max", "min", "step", "invalid", "invalidText"]);

      var numberInputClasses = (0, _classnames.default)(_defineProperty({
      ...
      var buttonControls = _react.default.createElement("div", {
      ...
      })), buttonControls, labelText, span, error);
    }
  }]);
