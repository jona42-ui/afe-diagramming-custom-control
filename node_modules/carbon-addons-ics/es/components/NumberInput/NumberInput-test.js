...
describe('NumberInput', function () {
  describe('should render as expected', function () {
    ...
    beforeEach(function () {
      ...
      inputWrapper = wrapper.find('.bx--number-input__wrapper');
      numberInput = wrapper.find('.bx--number');
    ...
    describe('input', function () {
      ...
      it('should set invalid as expected', function () {
        expect(wrapper.find('[data-invalid=true]').length).toEqual(0);
        wrapper.setProps({
          invalid: true
        });
        expect(wrapper.find('[data-invalid=true]').length).toEqual(1);
      });
    ...
    describe('Icon', function () {
      ...
      it('should use correct icons', function () {
        expect(icons.at(0).prop('name')).toEqual('up');
        expect(icons.at(1).prop('name')).toEqual('down');
      });
